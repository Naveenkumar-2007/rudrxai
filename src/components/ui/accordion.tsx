...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex flex-1 items-center justify-between py-6 font-medium font-heading text-lg transition-all hover:text-primary [&[data-state=open]>svg]:rotate-180 text-left",
        className
      )}
      {...props}
    >
