      ...
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-10 mb-12">
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground max-w-sm text-sm">
              RudrxAI builds production-grade websites, AI chatbots, dashboards, voice agents, and custom business platforms. Affordable. Fast. Reliable.
            </p>
          </div>
        ...
        <div className="pt-6 border-t flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} RudrxAI. All rights reserved.
          </p>
          <div className="flex gap-4">
            <a 
              href="https://github.com/RudrxAItechsolutions-hue/RudrxAI-" 
              target="_blank" 
            ...
            <a 
              href="https://www.linkedin.com/in/RudrxAI-tech-solutions-7a4a113b0/" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="text-muted-foreground hover:text-foreground transition-colors p-2 rounded-full hover:bg-muted"
              aria-label="LinkedIn"
            ...
            <a 
              href="https://www.instagram.com/RudrxAI/" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="text-muted-foreground hover:text-foreground transition-colors p-2 rounded-full hover:bg-muted"
